...
void Ui::CreateTables()
{
    ...
    _tabs[TAB_INDEX_OPTIONS] = new TabSeletable(LANG_OPTIONS, {new ItemConfig(LANG_LANGUAGE,
                                                                              ...
                                                                              {
                                                                                  LanguageString(gLanguageNamesWithIcon[LANGUAGE_ENGLISH]),
                                                                                  LanguageString(gLanguageNamesWithIcon[LANGUAGE_CHINESE]),
                                                                                  LanguageString(gLanguageNamesWithIcon[LANGUAGE_JAPANESE]),
                                                                                  LanguageString(gLanguageNamesWithIcon[LANGUAGE_ITALIAN]),
                                                                                  LanguageString(gLanguageNamesWithIcon[LANGUAGE_FRENCH]),
                                                                                  LanguageString(gLanguageNamesWithIcon[LANGUAGE_SPANISH]),
                                                                                  LanguageString(gLanguageNamesWithIcon[LANGUAGE_RUSSIAN]),
                                                                              },
