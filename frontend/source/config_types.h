...
enum GraphicsOverlayTransparency
{
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_0 = 0,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_10,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_20,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_30,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_40,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_50,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_60,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_70,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_80,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_90,
    CONFIG_GRAPHICS_OVERLAY_TRANSPARENCY_COUNT,
};
