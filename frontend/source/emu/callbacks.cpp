...
bool ClearAllThreadWaits(unsigned clear_threads, void *data)
{
    LogFunctionName;
    return true;
}
...
bool EnvironmentCallback(unsigned cmd, void *data)
{
    ...
    case RETRO_ENVIRONMENT_GET_CLEAR_ALL_THREAD_WAITS_CB:
        LogDebug("  cmd: RETRO_ENVIRONMENT_GET_CLEAR_ALL_THREAD_WAITS_CB");
        *(retro_environment_t *)data = ClearAllThreadWaits;
        break;
